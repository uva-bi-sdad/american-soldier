...
visualize_bigrams(white_long_bigrams, "White Soldiers' Long Response - Spatial Arrangement Bigrams")
```
...
#plot
visualize_cooccur(white_long_cors, "White Soldiers' Long Response - Spatial Arrangement Co-occurrences")
```
...
visualize_bigrams(seg_short_bigrams, "Anti-Integration Short Response - Spatial Arrangement Bigrams")
```
...
#plot
visualize_cooccur(seg_short_cors, "Anti-Integration Short Response - Spatial Arrangement Co-occurrences")
```
