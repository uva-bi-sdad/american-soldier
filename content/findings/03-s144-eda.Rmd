---
title: "Demographic Analyses of Black Soldiers"
description: "This page provides some exploratory data analysis of Survey 144."
weight: 3
...
```{r reading, echo=FALSE, include= F}
...
```{r edu, fig.width=7, fig.height=6, echo=FALSE}
demo %>% 
ggplot(aes(x=edu)) +
